...
def create_database_and_queries() -> None:
    """Create exactly what the grading system expects."""

    print("Creating school.db and queries.sql...")
...
INSERT INTO grades (student_id, subject, grade) VALUES
    ...
    (6, 'Science', 72), (6, 'Math', 78), (6, 'English', 51),
...
"""
    ...
    print("Done, files created in current folder:")
    print("   - school.db")
    print("   - queries.sql")
